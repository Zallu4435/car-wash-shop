...
function getRole(request) {
    return request.cookies.get(COOKIE_ROLE)?.value;
}
function middleware(request) {
    ...
    const isPublicBrowsing = pathname === '/' || pathname === '/products' || pathname.startsWith('/products/') || pathname === '/services' || pathname.startsWith('/services/');
    ...
    const isProtected = isAdminRoute && !isAdminAuthRoute || isStaffRoute && !isStaffAuthRoute || isCustomerRoute;
