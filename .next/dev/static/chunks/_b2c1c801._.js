...
"[project]/src/api/domains/admin-dashboard/fetchers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/api/domains/admin-dashboard/queries.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$domains$2f$admin$2d$dashboard$2f$fetchers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/api/domains/admin-dashboard/fetchers.ts [app-client] (ecmascript)");
...
const useAdminDashboard = ()=>{
    ...
    if ($[0] !== "31d9502e5bafe24779d2cd9f6f491e5ca97f4eabd47ccf6fa4bf184610e5b66e") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "31d9502e5bafe24779d2cd9f6f491e5ca97f4eabd47ccf6fa4bf184610e5b66e";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = {
            queryKey: adminDashboardKeys.summary(),
            queryFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$domains$2f$admin$2d$dashboard$2f$fetchers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminDashboardFetchers"].getDashboardSummary,
            staleTime: 60000,
...
_s(useAdminDashboard, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$domains$2f$admin$2d$dashboard$2f$queries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/api/domains/admin-dashboard/queries.ts [app-client] (ecmascript)");
...
function AdminDashboardPage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(68);
    if ($[0] !== "4eeb60354f33f6e66b857a653063a742118d9d5111f254bf1f8c15ce395e6f10") {
        for(let $i = 0; $i < 68; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4eeb60354f33f6e66b857a653063a742118d9d5111f254bf1f8c15ce395e6f10";
    }
    ...
    const { data: dashboardData, isLoading, error, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$domains$2f$admin$2d$dashboard$2f$queries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminDashboard"])();
    if (isLoading) {
        let t0;
        if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    if (error) {
        ...
        if ($[2] !== refetch) {
            t1 = ({
                "AdminDashboardPage[<Error>.onRetry]": ()=>refetch()
            })["AdminDashboardPage[<Error>.onRetry]"];
            $[2] = refetch;
            $[3] = t1;
        } else {
            t1 = $[3];
    ...
    if ($[8] !== router) {
        t1 = ({
            "AdminDashboardPage[<Button>.onClick]": ()=>router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2f$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AdminRoutes"].REPORTS)
    ...
    let t4;
    if ($[13] !== dashboardData?.totalRevenue) {
        t4 = dashboardData?.totalRevenue.toLocaleString() || "0";
        $[13] = dashboardData?.totalRevenue;
        $[14] = t4;
    } else {
        t4 = $[14];
    }
    const t5 = `₹${t4}`;
    const t6 = dashboardData?.revenueGrowth || "+0%";
    let t7;
    if ($[15] !== t5 || $[16] !== t6) {
    ...
    let t8;
    if ($[18] !== dashboardData?.totalOrders) {
        t8 = dashboardData?.totalOrders.toString() || "0";
        $[18] = dashboardData?.totalOrders;
        $[19] = t8;
    } else {
        t8 = $[19];
    }
    const t9 = dashboardData?.ordersGrowth || "+0%";
    let t10;
    if ($[20] !== t8 || $[21] !== t9) {
    ...
    let t11;
    if ($[23] !== dashboardData?.totalCustomers) {
        t11 = dashboardData?.totalCustomers.toString() || "0";
        $[23] = dashboardData?.totalCustomers;
        $[24] = t11;
    } else {
        t11 = $[24];
    }
    const t12 = dashboardData?.customersGrowth || "+0%";
    let t13;
    if ($[25] !== t11 || $[26] !== t12) {
    ...
    let t14;
    if ($[28] !== dashboardData?.totalStaff) {
        t14 = dashboardData?.totalStaff.toString() || "0";
        $[28] = dashboardData?.totalStaff;
        $[29] = t14;
    } else {
        t14 = $[29];
    }
    const t15 = dashboardData?.staffGrowth || "+0%";
    let t16;
    if ($[30] !== t14 || $[31] !== t15) {
    ...
    let t19;
    if ($[39] !== dashboardData?.recentOrders) {
        t19 = dashboardData?.recentOrders.map(_AdminDashboardPageAnonymous);
        $[39] = dashboardData?.recentOrders;
        $[40] = t19;
    } else {
        t19 = $[40];
    }
    ...
    let t22;
    if ($[44] !== dashboardData?.topServices) {
        t22 = dashboardData?.topServices.map({
            "AdminDashboardPage[(anonymous)()]": (service, index)=>{
                const maxBookings = Math.max(...dashboardData?.topServices.map(_AdminDashboardPageAnonymousAnonymous) || [
                    1
                ]);
        ...
        }["AdminDashboardPage[(anonymous)()]"]);
        $[44] = dashboardData?.topServices;
        $[45] = t22;
    } else {
        t22 = $[45];
    }
    ...
    let t26;
    if ($[52] !== dashboardData?.recentOrders) {
        t26 = dashboardData?.recentOrders.slice(0, 4).map(_AdminDashboardPageAnonymous2);
        $[52] = dashboardData?.recentOrders;
        $[53] = t26;
    } else {
        t26 = $[53];
    }
...
_s(AdminDashboardPage, "LNTUdzUUvXOPYAXsKsQmEw07Z38=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$domains$2f$admin$2d$dashboard$2f$queries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminDashboard"]
    ];
});
_c = AdminDashboardPage;
function _AdminDashboardPageAnonymous2(order_0) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function _AdminDashboardPageAnonymousAnonymous(s) {
    return s.bookings;
}
function _AdminDashboardPageAnonymous(order) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-1.5 sm:space-y-2",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/node_modules/.pnpm/lucide-react@0.546.0_react@19.2.0/node_modules/lucide-react/dist/esm/icons/chart-column.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/.pnpm/lucide-react@0.546.0_react@19.2.0/node_modules/lucide-react/dist/esm/icons/chart-column.js [app-client] (ecmascript) <export default as BarChart3>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "BarChart3",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$546$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chart$2d$column$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
...
"[project]/node_modules/.pnpm/lucide-react@0.546.0_react@19.2.0/node_modules/lucide-react/dist/esm/icons/chart-pie.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ChartPie = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$546$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("chart-pie", __iconNode);
;
 //# sourceMappingURL=chart-pie.js.map
}),
"[project]/node_modules/.pnpm/lucide-react@0.546.0_react@19.2.0/node_modules/lucide-react/dist/esm/icons/chart-pie.js [app-client] (ecmascript) <export default as PieChart>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "PieChart",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$546$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chart$2d$pie$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
...
"[project]/node_modules/.pnpm/lucide-react@0.546.0_react@19.2.0/node_modules/lucide-react/dist/esm/icons/trending-down.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/.pnpm/lucide-react@0.546.0_react@19.2.0/node_modules/lucide-react/dist/esm/icons/trending-down.js [app-client] (ecmascript) <export default as TrendingDown>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "TrendingDown",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$546$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trending$2d$down$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
...
//# sourceMappingURL=_b2c1c801._.js.map