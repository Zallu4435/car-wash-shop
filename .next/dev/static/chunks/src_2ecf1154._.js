...
function OrdersPage() {
    ...
    if ($[0] !== "075936359dc4695df911a15e2478a97a098cbf39f243ea390404d2e062bc1ade") {
        for(let $i = 0; $i < 35; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "075936359dc4695df911a15e2478a97a098cbf39f243ea390404d2e062bc1ade";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = {
    ...
    const { data: productData, isLoading: loadingProducts, error: productError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$domains$2f$orders$2f$queries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrders"])(t0);
    let t1;
    ...
    const { data: serviceData, isLoading: loadingServices, error: serviceError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$domains$2f$bookings$2f$queries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBookings"])(t1);
    let productTotal;
    let serviceTotal;
    let t2;
    if ($[3] !== productData?.data || $[4] !== productData?.total || $[5] !== serviceData?.data || $[6] !== serviceData?.total) {
        const rawProducts = productData?.data || [];
        const rawServices = serviceData?.data || [];
        productTotal = productData?.total ?? rawProducts.length;
        serviceTotal = serviceData?.total ?? rawServices.length;
        const normalizedProducts = rawProducts.map(_OrdersPageRawProductsMap);
        const normalizedServices = rawServices.map(_OrdersPageRawServicesMap);
        const combined = [
            ...normalizedProducts,
            ...normalizedServices
        ].sort(_OrdersPageAnonymous);
        t2 = combined.slice(0, 5);
        $[3] = productData?.data;
        $[4] = productData?.total;
        $[5] = serviceData?.data;
        $[6] = serviceData?.total;
    ...
    let t3;
    if ($[10] !== productTotal || $[11] !== serviceTotal) {
        t3 = {
    ...
    let t7;
    if ($[22] !== isLoading || $[23] !== stats.products) {
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(OverviewCard, {
    ...
    let t10;
    if ($[29] !== isLoading || $[30] !== recentOrders) {
        t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
            children: [
                ...
                isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    className: "space-y-3",
                    children: recentOrders.map(_OrdersPageRecentOrdersMap)
                }, void 0, false, {
                    fileName: "[project]/src/app/(customer)/orders/page.tsx",
                    lineNumber: 180,
                    columnNumber: 142
                }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(EmptyOrdersState, {}, void 0, false, {
                    fileName: "[project]/src/app/(customer)/orders/page.tsx",
                    lineNumber: 180,
                    columnNumber: 224
                }, this)
...
_s(OrdersPage, "EmYGbiBQ8KN1KLR3m1HU6H25yuA=", false, function() {
    return [
...
function _OrdersPageAnonymous(a, b) {
    return new Date(b.date).getTime() - new Date(a.date).getTime();
}
function _OrdersPageRawServicesMap(booking) {
    return {
        id: booking.id,
        type: "service",
        ...
        detailLink: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2f$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomerRoutes"].ORDER_SERVICE_DETAIL(booking.id),
        meta: booking.vehicleDetails ? `${booking.vehicleDetails.model} (${booking.vehicleDetails.number})` : undefined
    };
}
function _OrdersPageRawProductsMap(order) {
    return {
        id: order.id,
        type: "product",
        ...
        detailLink: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2f$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomerRoutes"].ORDER_PRODUCT_DETAIL(order.id),
...
function OverviewCard(t0) {
    ...
    const { title, count, icon: Icon, href, color, bgColor, loading } = t0;
    let t1;
    if ($[1] !== title) {
    ...
    let t2;
    if ($[3] !== count || $[4] !== loading) {
        t2 = loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const t4 = `h-12 w-12 rounded-full flex items-center justify-center ${bgColor} ${color}`;
    let t5;
    if ($[9] !== Icon) {
...
function ActivityItem(t0) {
    ...
    const t2 = item.detailLink;
    const t3 = `h-10 w-10 rounded-lg flex items-center justify-center shrink-0 ${isService ? "bg-blue-100/50 text-blue-600" : "bg-purple-100/50 text-purple-600"}`;
    let t4;
    if ($[3] !== Icon) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Icon, {
            className: "h-5 w-5"
    ...
    const t7 = `hidden sm:inline-flex capitalize ${statusColor} border-0 bg-opacity-10`;
    let t8;
    if ($[10] !== item.status || $[11] !== t7) {
    ...
    let t11;
    if ($[17] !== item.date) {
        t11 = new Date(item.date).toLocaleDateString();
        $[17] = item.date;
        $[18] = t11;
    } else {
        t11 = $[18];
    ...
    let t13;
    if ($[21] !== item.meta) {
        t13 = item.meta && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    const t17 = `sm:hidden capitalize text-[10px] h-5 px-1.5 ${statusColor} border-0 bg-opacity-10`;
    let t18;
    if ($[31] !== item.status || $[32] !== t17) {
...
__turbopack_context__.k.register(_c3, "EmptyOrdersState");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_2ecf1154._.js.map