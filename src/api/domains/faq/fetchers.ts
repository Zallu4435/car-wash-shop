...
const mockFAQs: FAQ[] = [
  ...
  { id: '4', question: 'How do I contact customer support?', answer: 'You can reach our customer support team by calling our hotline or emailing us. We typically respond within 24 hours.', categoryId: 'general', order: 4, isActive: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
