      ...
      <div className="container-custom py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Service Image */}
            <div className="relative h-[400px] bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl overflow-hidden border border-border">
              ...
              <Badge className="absolute top-4 right-4 bg-card border-border shadow-lg">
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <CardTitle>Enhance Your Service</CardTitle>
                </div>
                <p className="text-sm text-muted-foreground">Select optional add-ons to customize your service</p>
              </CardHeader>
              <CardContent>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <Label htmlFor={addon.id} className="font-semibold cursor-pointer text-foreground">
                            {addon.name}
                          </Label>
              ...
              <CardContent className="space-y-6 pt-6">
                ...
                <div className="space-y-2 pt-4 border-t border-border">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-muted-foreground">Free cancellation up to 2 hours before service</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-600 dark:text-green-500 mt-0.5 flex-shrink-0" />
                    <p className="text-xs text-muted-foreground">Professional staff with verified credentials</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-600 dark:text-green-500 mt-0.5 flex-shrink-0" />
