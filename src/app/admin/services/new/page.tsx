        ...
        <CardHeader className="pb-3 sm:pb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              <CardTitle className="text-base sm:text-lg md:text-xl">Add New Service</CardTitle>
              <p className="text-xs sm:text-sm text-muted-foreground mt-0.5 sm:mt-1">Create a new service offering</p>
            </div>
          </div>
        </CardHeader>
        <CardContent>
