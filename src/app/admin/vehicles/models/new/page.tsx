        ...
        <CardHeader className="pb-3 sm:pb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              <CardTitle className="text-base sm:text-lg md:text-xl">Add New Vehicle Model</CardTitle>
              <p className="text-xs sm:text-sm text-muted-foreground mt-0.5 sm:mt-1">Add a new vehicle model to the system</p>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="space-y-1.5 sm:space-y-2">
                ...
                />
                {errors.fuelType && (
                  <p className="text-[10px] sm:text-xs text-red-600 dark:text-red-400">{errors.fuelType.message}</p>
                )}
              </div>
            </div>
