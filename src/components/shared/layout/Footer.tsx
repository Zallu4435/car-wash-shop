        ...
        <div className="section-padding-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="relative">
                  ...
                  <div className="relative bg-primary p-3 rounded-xl shadow-xl">
                    <Droplet className="h-7 w-7 text-primary-foreground" />
                  </div>
                </div>
                <div className="flex flex-col">
                  <span className="text-2xl font-bold text-foreground tracking-tight">CarWash</span>
              ...
              {/* Newsletter */}
              <div className="mb-6">
                <h4 className="text-foreground font-semibold mb-3 text-sm">Subscribe to Our Newsletter</h4>
                <form onSubmit={handleSubscribe} className="flex gap-2">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-xl bg-muted border border-border text-foreground text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary transition-all"
                      required
                    />
                  </div>
                  <button
                    type="submit"
                    className="px-5 py-3 rounded-xl bg-primary text-primary-foreground font-medium hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 flex items-center gap-2"
                  >
                    {subscribed ? (
                      <>
              ...
              <div className="flex gap-3">
                {[Facebook, Instagram, Twitter, Linkedin].map((Icon, idx) => (
                  <a
                    key={idx}
                    href="#"
                    className="p-3 rounded-xl bg-muted hover:bg-primary hover:text-primary-foreground transition-all duration-300 group"
            ...
            <div className="lg:col-span-2">
              <h4 className="text-foreground font-semibold mb-5 text-sm uppercase tracking-wider">Services</h4>
              <ul className="space-y-3">
                {footerLinks.services.map((link) => (
                  <li key={link.name}>
                    ...
                    >
                      <ArrowRight className="h-3.5 w-3.5 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300 text-primary" />
                      {link.name}
                    </a>
                  </li>
                ))}
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={item.label} className="flex items-start gap-3 group">
                    <div className="p-2.5 rounded-xl bg-muted group-hover:bg-primary transition-all duration-300">
                      <item.Icon className="h-4 w-4 text-muted-foreground group-hover:text-primary-foreground transition-colors" />
                    </div>
                    <div className="flex flex-col">
